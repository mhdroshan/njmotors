...
window.SCOOTERS_DATA = [
  {
    ...
    "description": "Legend is engineered for college students and everyday city commuters. Available in both Lithium (3-Year Warranty, Fast Charging) and Graphene (1-Year Warranty) battery variants with zero registration paperwork.",
    "batteryVariants": {
      "lithium": {
  ...
  },
  {
    ...
    "warranty": "3 Years (Lithium) / 1 Year (Graphene)",
    "licenseRequired": "No Driving License Required (CMVR Non-RTO)",
    "description": "Fusion blends stylish dynamic body styling with reliable electric engineering. Choose between high-performance Lithium with Fast Charging & 3-year warranty, or economical Graphene battery with 1-year warranty.",
    "batteryVariants": {
      "lithium": {
        "name": "Lithium Battery (Smart BMS)",
        "type": "Advanced Li-ion with Smart BMS",
  ...
  },
  {
    ...
    "warranty": "3 Years (Lithium) / 1 Year (Graphene)",
    "licenseRequired": "No Driving License Required (CMVR Non-RTO)",
    "description": "Falcon is crafted with sharp aerodynamic contours and swift acceleration for effortless daily commuting. Available with Lithium (Fast Charge, 3-Yr Warranty) or Graphene (1-Yr Warranty) packs.",
    "batteryVariants": {
      "lithium": {
        "name": "Lithium Battery (Smart BMS)",
        "type": "Advanced Li-ion with Smart BMS",
  ...
  },
  {
    ...
    "warranty": "3 Years (Lithium) / 1 Year (Graphene)",
    "licenseRequired": "No Driving License Required (CMVR Non-RTO)",
    "description": "Optima delivers maximum cost-efficiency, smooth low-drag acceleration, and everyday reliability with minimal operating costs under ₹0.15/km.",
    "batteryVariants": {
      "lithium": {
        "name": "Lithium Battery (Smart BMS)",
  ...
  },
  {
    ...
    "warranty": "3 Years (Lithium) / 1 Year (Graphene)",
    "licenseRequired": "No Driving License Required (CMVR Non-RTO)",
    "description": "Phantom delivers imposing road presence, 12-inch oversized alloy wheels, colored digital display, and a 60/72V dual-voltage controller with Lithium or Graphene battery options.",
    "batteryVariants": {
      "lithium": {
        "name": "Lithium Battery (Smart BMS)",
  ...
  },
  {
    ...
    "warranty": "3 Years (Lithium) / 1 Year (Graphene)",
    "licenseRequired": "No Driving License Required (CMVR Non-RTO)",
    "description": "Destiny combines elegant curves, plush dual-density seating, deep under-seat boot space, and smart keyless security with Lithium or Graphene battery options.",
    "batteryVariants": {
      "lithium": {
        "name": "Lithium Battery (Smart BMS)",
